...
- [x] Task: Measure - User Manual Verification 'Phase 1' (Protocol in workflow.md) `1769789`
...
- [x] Task: Refactor `listProjects()` for two-level directory scanning `4dd6f4f`
    ...
    - [x] Ensure `listProjects()` ignores non-project directories (dashboard, measure, .git, etc.)
...
- [x] Task: Measure - User Manual Verification 'Phase 2' (Protocol in workflow.md) `4dd6f4f`
