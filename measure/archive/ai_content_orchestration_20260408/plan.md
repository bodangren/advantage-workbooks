...
- [ ] Task: Measure — User Manual Verification 'Phase 1: Foundation — Library & Schema Prep' (Protocol in workflow.md)
...
- [ ] Task: Measure — User Manual Verification 'Phase 2: API Route — Server-Side Generation Endpoint' (Protocol in workflow.md)
...
- [x] Task: Measure — User Manual Verification 'Phase 3: Dashboard UI — Modal & Source Input' (Protocol in workflow.md)
...
- [x] Task: Update `measure/tech-debt.md` and `measure/lessons-learned.md` (prune to <=50 lines each). Note the Gemini structured-output JSON prompt pattern as a reusable approach.
- [x] Task: Measure — User Manual Verification 'Phase 4: Integration & Final Quality Gate' (Protocol in workflow.md)
