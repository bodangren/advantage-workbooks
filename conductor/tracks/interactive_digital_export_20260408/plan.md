...
- [ ] Task: Conductor — User Manual Verification 'Phase 1: Foundation — Templates & Shared Utilities' (Protocol in workflow.md)
...
- [ ] Task: Conductor — User Manual Verification 'Phase 2: Standalone HTML Exporter' (Protocol in workflow.md)
...
- [ ] Task: Conductor — User Manual Verification 'Phase 3: SCORM Exporter' (Protocol in workflow.md)
...
- [ ] Task: Update `conductor/tech-debt.md` and `conductor/lessons-learned.md` (prune to <=50 lines). Note the in-memory `archiver` pattern for SCORM zip generation and the single-file inlining approach.
- [ ] Task: Conductor — User Manual Verification 'Phase 4: API Route & Dashboard UI' (Protocol in workflow.md)
