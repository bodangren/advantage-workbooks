...
- [ ] Task: Conductor — User Manual Verification 'Phase 1: Schema & Configuration Foundation' (Protocol in workflow.md)
...
- [ ] Task: Conductor — User Manual Verification 'Phase 2: Bilingual Activity Instructions in Templates' (Protocol in workflow.md)
...
- [ ] Task: Conductor — User Manual Verification 'Phase 3: Thai Instructional Script Generator' (Protocol in workflow.md)
...
- [ ] Task: Update `conductor/tech-debt.md` and `conductor/lessons-learned.md` (prune to <=50 lines). Document the static `TH_INSTRUCTIONS` approach (prefer static strings over AI for UI copy) and the Gemini classroom-register Thai prompt pattern.
- [ ] Task: Conductor — User Manual Verification 'Phase 4: Teacher Guide Template & UI Integration' (Protocol in workflow.md)
