...
- [ ] Task: Conductor — User Manual Verification 'Phase 1: Schema Extension & Backward Compatibility Guard' (Protocol in workflow.md)
...
- [ ] Task: Conductor — User Manual Verification 'Phase 2: Activity Generators' (Protocol in workflow.md)
...
- [ ] Task: Conductor — User Manual Verification 'Phase 3: Handlebars Templates for New Activity Types' (Protocol in workflow.md)
...
- [ ] Task: Update `conductor/tech-debt.md` and `conductor/lessons-learned.md` (prune to <=50 lines). Document the crossword interlocking algorithm approach and the vanilla DnD pattern.
- [ ] Task: Conductor — User Manual Verification 'Phase 4: Section Builder UI' (Protocol in workflow.md)
