...
- [ ] Task: Conductor — User Manual Verification 'Phase 1: Supabase Client Setup & Database Schema' (Protocol in workflow.md)
...
- [ ] Task: Conductor — User Manual Verification 'Phase 2: Data Access Layer' (Protocol in workflow.md)
...
- [ ] Task: Conductor — User Manual Verification 'Phase 3: API Route Refactor' (Protocol in workflow.md)
...
- [ ] Task: Conductor — User Manual Verification 'Phase 4: Authentication' (Protocol in workflow.md)
...
- [ ] Task: Update `conductor/tech-debt.md` and `conductor/lessons-learned.md` (prune to <=50 lines). Document the Supabase SSR pattern for Next.js Server Components and the RLS "authenticated users only" policy approach.
- [ ] Task: Conductor — User Manual Verification 'Phase 5: Real-Time Presence & Migration Script' (Protocol in workflow.md)
